        ...
        <div className="xl:divide-y xl:divide-amber-100/50 xl:dark:divide-amber-800/30">
          ...
          <div className="grid-rows-[auto_1fr] divide-y divide-emerald-100/50 pb-8 dark:divide-emerald-800/30 xl:grid xl:grid-cols-4 xl:gap-x-8 xl:divide-y-0">
            ...
            <div className="xl:col-span-3 xl:row-span-2 xl:pb-0">
              <div className="prose prose-gray max-w-none pb-10 pt-12 dark:prose-invert prose-headings:text-gray-800 prose-p:text-gray-700 prose-a:text-emerald-600 prose-a:no-underline hover:prose-a:text-amber-600 prose-blockquote:border-l-emerald-300 prose-blockquote:text-gray-600 prose-code:rounded prose-code:border prose-code:border-orange-200/50 prose-code:bg-gradient-to-r prose-code:from-orange-50 prose-code:to-amber-50 prose-code:px-1.5 prose-code:py-0.5 prose-code:font-mono prose-code:text-sm prose-code:text-orange-600 prose-code:shadow-sm prose-code:before:content-[''] prose-code:after:content-[''] prose-pre:rounded-xl prose-pre:border prose-pre:border-emerald-200/30 prose-pre:bg-gradient-to-br prose-pre:from-emerald-50/80 prose-pre:via-amber-50/60 prose-pre:to-orange-50/80 prose-pre:shadow-xl prose-pre:ring-1 prose-pre:ring-emerald-200/20 prose-li:text-gray-700 dark:prose-headings:text-gray-100 dark:prose-p:text-gray-300 dark:prose-a:text-emerald-400 dark:hover:prose-a:text-amber-400 dark:prose-blockquote:border-l-emerald-600 dark:prose-blockquote:text-gray-400 dark:prose-code:border-orange-700/30 dark:prose-code:from-orange-900/30 dark:prose-code:to-amber-900/30 dark:prose-code:text-orange-400 dark:prose-pre:border-emerald-700/30 dark:prose-pre:from-emerald-950/40 dark:prose-pre:via-amber-950/30 dark:prose-pre:to-orange-950/40 dark:prose-pre:ring-emerald-700/10 dark:prose-li:text-gray-300">
                {children}
              </div>
