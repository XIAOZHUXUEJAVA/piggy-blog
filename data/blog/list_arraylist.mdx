---
title: List<Integer> list = new ArrayList<>(); 和 ArrayList<Integer> list = new ArrayList<>(); 两者的区别
date: '2024-12-22'
tags: ['java']
draft: false
summary: 写Java代码无意间想到的一点
---
...
总结认识：这其实是Java中一个非常基础的问题，但是里面蕴藏的知识也非常丰富, Think More !!!
